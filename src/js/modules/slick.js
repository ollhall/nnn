  ...
  (function (factory) {
      ...
      function Slick(element, settings) {
        ...
        _.defaults = {
          ...
          prevArrow:
            ...
            '<span class="slick-sr-only">Попередній слайд</span>' +
            "</button>",
          nextArrow:
            '<button class="slick-next" type="button">' +
            '<span class="slick-next-icon" aria-hidden="true"></span>' +
            '<span class="slick-sr-only">Наступний слайд</span>' +
            "</button>",
          autoplay: false,
          autoplaySpeed: 3000,
          centerMode: false,
          ...
          customPaging: function (slider, i) {
            return $(
              '<button type="button">' +
                ...
                '<span class="slick-sr-only">Перейти до слайду ' +
                (i + 1) +
                "</span>" +
                "</button>"
            );
    ...
    Slick.prototype.addSlide = Slick.prototype.slickAdd = function (
      ...
      _.$slides.each(function (index, element) {
        ...
        $(element).attr("aria-label", "Слайд " + index);
      });
    ...
    Slick.prototype.buildOut = function () {
      ...
      if (_.options.autoplay && _.options.useAutoplayToggleButton) {
        ...
        _.$pauseButton.append(
          $('<span class="slick-pause-text slick-sr-only">Пауза</span>')
        );
        _.$pauseButton.append(
          $(
            '<span class="slick-play-text slick-sr-only" style="display: none">Відтворення</span>'
          )
        );
